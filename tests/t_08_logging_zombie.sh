...
make_all_mocks
MOCK_HASSESSION=0 run_launcher "$SBX"
...
new_sandbox
make_all_mocks
RP_YES=1 run_launcher "$SBX/does-not-exist-xyz"
...
MOCK_REACH=fail MOCK_HASSESSION=0 run_launcher "$SBX"
...
new_sandbox
make_all_mocks
MOCK_REACH=ok MOCK_DIRCHECK=__YES__ run_launcher "$SBX"
