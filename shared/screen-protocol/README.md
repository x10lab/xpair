...
| 소비자 | 구현 |
|--------|------|
| `rs/remote-pair-screen/src/serve.rs` | v1a WS+JPEG 서버 (port 8889 default) |
| `rs/remote-pair-screen/src/serve_webrtc.rs` | v2 WebRTC (signaling 8890) |
| `ide/remotepair-ext/extension.js` | 터널·InputServer 전달·포트 상수(SIDECAR/SIGNAL) |
| `ide/remotepair-ext/media/remote-desktop.js` | 웹뷰 렌더·입력 캡처·메시지 어휘 |
