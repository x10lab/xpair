...
declare global {
  interface Window {
    remotepair: {
      ...
      // force:true reinstalls the bundled XpairHost over a missing/incompatible/dead host app —
      // used by the in-UI host-repair flow. The host restarts (running tmux sessions die).
